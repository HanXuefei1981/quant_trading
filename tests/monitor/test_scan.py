...
def _sample_rows(n: int, date: str = "2026-05-18") -> list[dict]:
    """Generate n sample scan rows with sequential ranks."""
    return [
        {
            "date": date,
            "code": f"{300500 + i:06d}",
...
class TestScanReadsSignals:
    def test_reads_signals_sorted_by_rank(self, tmp_path):
        ...
        _make_scan_csv(tmp_path, "2026-05-18", shuffled)
    ...
    def test_reads_correct_number_of_signals(self, tmp_path):
        ...
        _make_scan_csv(tmp_path, "2026-05-18", _sample_rows(60))
    ...
    def test_returns_fewer_signals_if_not_enough_rows(self, tmp_path):
        ...
        _make_scan_csv(tmp_path, "2026-05-18", _sample_rows(10))
        result = get_scan(tmp_path, top_n=50, buffer_n=5)
    ...
    def test_signal_row_has_correct_fields(self, tmp_path):
        ...
        _make_scan_csv(tmp_path, "2026-05-18", _sample_rows(3))
    ...
    def test_code_is_zero_padded_string(self, tmp_path):
        ...
        rows = [{
            "date": "2026-05-18",
            "code": "000089",  # would be interpreted as int 89 without padding
            "close": 6.76,
            "signal": 1.5,
            "ret1": 0.1,
            "rank": 1,
        ...
        _make_scan_csv(tmp_path, "2026-05-18", rows)
    ...
    def test_code_integer_in_csv_is_zero_padded(self, tmp_path):
        ...
        rows = [{
            "date": "2026-05-18",
            "code": 89,  # integer form — same as "000089"
            "close": 6.76,
            "signal": 1.5,
            "ret1": 0.1,
            "rank": 1,
...
class TestScanNorthBound:
    def test_north_5d_is_always_none(self, tmp_path):
        ...
        _make_scan_csv(tmp_path, "2026-05-18", _sample_rows(5))
        result = get_scan(tmp_path, top_n=5, buffer_n=0)
